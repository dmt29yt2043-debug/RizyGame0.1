...
export function createVFX(ctx, options){
  ...
  // МАГНИТНЫЙ ШЛЕЙФ энергона к груди Ризи (uTarget), smoothstep по пути, лесенкой рождений по 18 мс.
  ...
  function eMagnet(x, y, z, o, T0){
    ...
    for (let i = 0; i < n; i++){
      ...
      // LATE_FADE: иначе частица гаснет ровно там, где путь наконец доносит её до груди, и лента
